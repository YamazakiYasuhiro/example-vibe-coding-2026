...
- `.codex/rules/coding-rules.md` - Applies when writing or reviewing Python/TypeScript code
...
- `.codex/rules/logging-rules.md` - Applies when writing Python code that includes logging statements
